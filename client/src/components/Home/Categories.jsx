        ...
        <>
            <div className="flex md:flex-row flex-col justify-around m-5 mt-10  gap-5">
                {categories.map((category, index) => {
                    return (
                        <div key={index} className="flex w-full md:h-[35rem] h-[25rem] justify-center items-center bg-cover" style={{ backgroundImage: `url(${category.img})`, backgroundPosition: "center" }}>
            ...
            <div className="flex md:flex-row flex-col justify-around gap-5 m-5">
                {[
                    ...
                    return (
                        <div key={index} className="flex w-full md:h-[30rem] h-[20rem] justify-center items-center bg-cover" style={{ backgroundImage: `url(${category.img})`, backgroundPosition: "center" }}>
                            <div className="flex flex-col items-center">
                                <h1 className="text-[40px] text-white whitespace-nowrap font-bold">{category.title}</h1>
                                <Link to={"/list-product"} className=" w-40 mt-4 p-2 font-semibold bg-white hover:bg-slate-300 text-black">
                                    SHOP NOW
